  ...
  return (
    ...
    >
      <div className="space-y-3">
        ...
        <div>
          <label className="block text-[12px] font-bold text-slate-600 mb-1 uppercase tracking-wide">Current Password <span className="text-red-500">*</span></label>
          <PasswordField 
            placeholder="••••••••" 
        ...
        <div>
          <label className="block text-[12px] font-bold text-slate-600 mb-1 uppercase tracking-wide">New Password <span className="text-red-500">*</span></label>
          <PasswordField 
            placeholder="••••••••" 
            value={passwords.new} 
        ...
        <div>
          <label className="block text-[12px] font-bold text-slate-600 mb-1 uppercase tracking-wide">Confirm New Password <span className="text-red-500">*</span></label>
          <PasswordField 
            placeholder="••••••••" 
