...
const Modal = ({ isOpen, onClose, title, children, footer }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 bg-black/50 backdrop-blur-sm animate-fadeIn overscroll-none">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden flex flex-col max-h-[calc(var(--app-height)-1.5rem)] animate-scaleIn">
